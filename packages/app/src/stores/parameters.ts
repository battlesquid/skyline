...
export const getComputedParameters = (inputs: SkylineModelInputParameters): SkylineModelComputedParameters => {
...
export const DEFAULT_COMPUTED_PARAMETERS = Object.freeze(getComputedParameters(DEFAULT_INPUT_PARAMETERS))
...
export const createParametersStore = (
    ...
    const allComputedProps = { ...DEFAULT_COMPUTED_PARAMETERS, ...getComputedParameters(allInputProps) };
